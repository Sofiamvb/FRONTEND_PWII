                        ...
                        <div className="min-w-[1050px] w-full overflow-hidden bg-[#FFFDF8] shadow-[0_3px_6px_rgba(0,0,0,0.20)]">
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex h-[58px] w-[58px] shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#FAE568]">
                                        <img
                                ...
                                <p className="whitespace-nowrap text-[13px] font-medium">
                                    04 agosto 2026, 1:20 p.m.
                                </p>


                                <Link
                                    to="/home/purchases/detail"
                                    className="
                                        flex
                                        h-[31px]
                                        w-[62px]
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex h-[58px] w-[58px] shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#83CBFC]">
                                        <img
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="relative flex h-[58px] w-[58px] shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#83CBFC]">

                                        <div className="h-[29px] w-[42px] -rotate-[18deg] rounded-[3px] bg-[#252429] shadow-md">
